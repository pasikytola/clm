...
Kuvailen seuraavaksi osakkeet, jota Markowitz käyttää kirjassaan kandidaatteina portfolioiden komponenteiksi. Olen naputellut osakkeiden tuotot eri vuosilta data.txt-tiedostoon vuoden 1959 kirjasta.
...
Unit cross tarkoittaa ristin muodossa olevaa pysty- ja sarakevektoria, joiden muut elementit paitsi risteys on 0. Risteys on 1. Eli esim
...
Kuvajaan on plotattu myös yksittäiset yhdeksän osaketta. Kuvaja, kuten myös kulmaportfoliot, täsmäävät kirjan [3] (s. 20, 25) kanssa.
